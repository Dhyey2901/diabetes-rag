...
plasma or increased A1C in the blood. Diabetes is classiﬁed conventionally into sev-
eral clinical categories (e.g., type 1 or type 2 diabetes, gestational diabetes mellitus,
and other speciﬁc types derived from other causes, such as monogenic diabetes, exo-
...
diagnosis requires conﬁrmatory testing (Table 2.1). B
...
over, the efﬁcacy of interventions for pri-
...
those with prediabetes deﬁned by A1C
criteria (5–8).
...
ﬁed anywhere along the spectrum of
...
insufﬁcient evidence to support the use
...
of random plasma glucose is sufﬁcient
...
cause, in addition to conﬁrming that
...
ﬁed by the National Glycohemoglobin
...
Improvement Amendments–certiﬁed
...
deﬁciency, HIV, hemodialysis, recent
...
certiﬁed but many more are International
Federation of Clinical Chemistry (IFCC) cer-
tiﬁed (a similarly stringent process) (1).
Point-of-care A1C assays may be NGSP
certiﬁed and cleared by the U.S. Food
...
CLIA certiﬁed, are inspected, and meet the
CLIA quality standards. These standards
include speciﬁed personnel requirements
(including documented annual compe-
tency assessments) and participation three
times per year in an approved proﬁciency
...
(Table 2.3).
A1C reﬂects glucose bound to hemoglo-
...
A1C
Cost
Inexpensive and available in most laboratories
across the world
More expensive than glucose and not as
widely available globally
Time frame of hyperglycemia
Acute measure
Chronic measure of glucose exposure over
the past 2–3 months
Preanalytic stability
Poor; plasma must be separated immediately
or samples must be kept on ice to prevent
glycolysis
Good
Sample
Measurement can vary depending on sample
...
Nonfasting test; no participant preparation is
needed
...
Unaffected by recent food intake, stress,
illness, activity
...
phosphate dehydrogenase deﬁciency,
erythropoietin), HIV, cirrhosis, renal failure,
dialysis, pregnancy
Test interferences
Depends on speciﬁc assay: sample handling/
processing time, hemolysis, severe
hypertriglyceridemia, severe
hyperbilirubinemia
Depends on speciﬁc assay: hemoglobin
...
sults, but this depends on the speciﬁc as-
...
random plasma glucose $200 mg/dL
[$11.1 mmol/L]), conﬁrmation is neces-
...
diagnosis of diabetes is conﬁrmed. Two
...
would also conﬁrm the diagnosis. On the
...
diagnosis is made based on the conﬁrma-
...
3. Speciﬁc types of diabetes due to other
...
may vary considerably. Classiﬁcation is
important for determining personalized
therapy, but some individuals cannot be
clearly classiﬁed as having type 1 or type 2
...
(<25 kg/m2), unintentional weight loss, ke-
toacidosis, and plasma glucose >360 mg/dL
(>20 mmol/L) at presentation (36) (Fig. 2.1).
...
1No single clinical feature conﬁrms type 1 diabetes in isolation. 2Glutamic acid decarboxylase (GAD) should be the primary antibody measured
...
<58 mmol/mol (<7.5%) at diagnosis, one parent with diabetes, features of a speciﬁc monogenic cause (e.g., renal cysts, partial lipodystrophy,
...
ple (with concurrent glucose) within 5 h of eating can replace a formal C-peptide stimulation test in the context of classiﬁcation. If the result is
...
clude severe insulin deﬁciency. Do not test C-peptide within 2 weeks of a hyperglycemic emergency. 5Features of type 2 diabetes include increased
...
family history of autoimmunity. 6If genetic testing does not conﬁrm monogenic diabetes, the classiﬁcation is unclear and a clinical decision should
...
tiﬁcation of individualized therapies for
...
to more precisely deﬁne the subsets of
...
bolic beneﬁts) and monitoring systems.
...
pendent on the age at ﬁrst detection of
an autoantibody, number of autoanti-
bodies, autoantibody speciﬁcity, and au-
...
abetes have been deﬁned (Table 2.4)
...
tory capacity. For this classiﬁcation, all
...
classiﬁcation may lead to misclassiﬁcation
of some individuals with type 2 diabetes.
Diagnostic accuracy may be improved
by using higher-speciﬁcity tests, using
conﬁrmatory testing for other autoanti-
...
diabetes, but deﬁcient b-cell insulin
...
tion, epigenetic changes, inﬂammation,
and metabolic stress. Future classiﬁca-
...
2.8 Having multiple conﬁrmed islet
...
ﬁed, referral to a specialized center
...
our-research/prevention-studies)
(40–42,
...
to identify high-risk populations. Speciﬁc
...
type 1 diabetes is deﬁned by the presence
...
speciﬁcity of autoantibodies as well as age
...
can be deﬁned by one or more criteria as
...
DKA as the ﬁrst manifestation of the dis-
...
or other stress. Adults may retain sufﬁ-
...
deﬁned. Although individuals did not clas-
